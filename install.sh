...
mkdir -p /donb/openvpn
wget -qO /donb/openvpn/client-udp.ovpn "https://raw.githubusercontent.com/akuhaa021/autoscript/main/FILES/openvpn/client-udp.ovpn"
wget -qO /donb/openvpn/client-tcp.ovpn "https://raw.githubusercontent.com/akuhaa021/autoscript/main/FILES/openvpn/client-tcp.ovpn"
sed -i "s/xx/$ip/g" /donb/openvpn/client-udp.ovpn
sed -i "s/xx/$ip/g" /donb/openvpn/client-tcp.ovpn
echo -e "\n<ca>" >> /donb/openvpn/client-tcp.ovpn
cat "/etc/openvpn/key/ca.crt" >> /donb/openvpn/client-tcp.ovpn
echo -e "</ca>" >> /donb/openvpn/client-tcp.ovpn
echo -e "\n<ca>" >> /donb/openvpn/client-udp.ovpn
cat "/etc/openvpn/key/ca.crt" >> /donb/openvpn/client-udp.ovpn
echo -e "</ca>" >> /donb/openvpn/client-udp.ovpn
...
mkdir /donb/wireguard
touch /donb/wireguard/wireguard-clients.txt
...
if [[ "$variant" == 1 ]]; then
	wget -qO /usr/bin/menu "https://raw.githubusercontent.com/akuhaa021/autoscript/main/FILES/menu/menu-xray.sh"
	...
	wget -qO /usr/bin/menu "https://raw.githubusercontent.com/akuhaa021/autoscript/main/FILES/menu/menu-v2ray.sh"
	wget -qO /usr/bin/v2ray-script "https://raw.githubusercontent.com/akuhaa021/autoscript/main/FILES/menu/v2ray-script.sh"
...
if [[ "$variant" == 1 ]]; then
	wget -qO /usr/bin/script-2 "https://raw.githubusercontent.com/akuhaa021/autoscript/main/FILES/cron/script-2-xray.sh"
elif [[ "$variant" == 2 ]]; then
	wget -qO /usr/bin/script-2 "https://raw.githubusercontent.com/akuhaa021/autoscript/main/FILES/cron/script-2-v2ray.sh"
fi
...
mkdir /donb/script-3
touch /donb/script-3/{multi-login.log,user-lock.log}
echo 2 > /donb/script-3/limit
systemctl daemon-reload
service script-3 start
systemctl enable script-3

# Configure block all connections
echo off >> /donb/block-status
