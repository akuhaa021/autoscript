...
function add-user() {
	...
	echo -e ""
	echo -e "Link Digi    : vless://$uuid@plus.google.com.my.$domain:3646?security=xtls&flow=xtls-rprx-direct&sni=vault21.digi.com.my#XTLS-$domain"
	echo -e "Link Umobile : vless://$uuid@wap.u.com.my.$domain:3646?security=xtls&flow=xtls-rprx-direct&sni=clubopen.pubgmobile.com.wap.u.com.my#XTLS-$domain"
