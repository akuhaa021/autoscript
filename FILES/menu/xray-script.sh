...
function add-user() {
	...
	echo -e ""
	echo -e "Link Digi    : vless://$uuid@plus.google.com.my.$domain:443?headerType=none&type=tcp&encryption=none&flow=xtls-rprx-direct&security=xtls&sni=vault21.digi.com.my#vless_SG0_xtls_Digi_$user"
	echo -e "Link Umobile : vless://$uuid@wap.u.com.my.$domain:443?headerType=none&type=tcp&encryption=none&flow=xtls-rprx-direct&security=xtls&sni=clubopen.pubgmobile.com.wap.u.com.my#vless_SG0_xtls_Umobile_$user"
